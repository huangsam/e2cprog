...
public class TK {
    ...
    public static final TK REPEAT  = new TK("TK.REPEAT");  // repeat - part 12
    public static final TK UNTIL   = new TK("TK.UNTIL");   // until - part 12
    ...
    public static final TK DID     = new TK("TK.DID");     // decl_identifier
