...
if(3<5){
int x_c[] = {
27, 10, 4444, 4444, 4444, 4444, 4444, 4444, 4444, 4444, 4444, 4444, 4444, }
;
for(x_b=27;
x_b<=36;
x_b++){
x_c[bc(x_c, 20, x_b, 'c')]=x_a[bc(x_a, 20, x_b-26, 'a')];
}
for(x_b=36;
x_b>
=27;
...
x_e<=10;
x_e++){
if(x_a[bc(x_a, 35, x_b, 'a')]>
x_a[bc(x_a, 35, x_e, 'a')]){
int x_t=8888;
x_t=x_a[bc(x_a, 37, x_b, 'a')];
x_a[bc(x_a, 38, x_b, 'a')]=x_a[bc(x_a, 38, x_e, 'a')];
x_a[bc(x_a, 39, x_e, 'a')]=x_t;
}
}
}
for(x_b=1;
